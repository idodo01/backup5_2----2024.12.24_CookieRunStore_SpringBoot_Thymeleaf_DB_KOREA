...
CREATE TABLE `order` (
  ...
  `shipping_addr` varchar(255) DEFAULT NULL,
  `shipping_postcode` varchar(255) DEFAULT NULL,
  `shipping_addr_detail` varchar(255) DEFAULT NULL,
...
INSERT INTO `order` VALUES ('7b485cd156','korea','imp_810216968308',NULL,50000,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2024-12-23 20:27:13');
